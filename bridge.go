...
// Accessory factory
func NewYeelight(info accessory.Info, ip, port string) *accessory.Lightbulb {
...
func updateStatus(lightbulb *accessory.Lightbulb, saturation, hue, power, bright string) error {
